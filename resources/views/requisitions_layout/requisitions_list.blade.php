...
<div class="modal fade" id="editReqModal_{{$requisition->id}}" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="form-group">
        <label class="required">UB Email</label>
        <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" id="email" value="{{$requisition->email}}" minlength="2" maxlength="40" required>
        @error('email')
            <span class="text-danger">{{$message}}</span>
        @enderror
    </div>
...
<div class="modal fade" id="createReqModal" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="form-group">
        <label class="required">UB Email</label>
        <input class="form-control @error('material_type') is-invalid @enderror" type="email" name="email" id="email" value="{{ old('email') }}"  minlength="2" maxlength="25" required>
        @error('email')
            <span class="text-danger">{{$message}}</span>
        @enderror
    </div>
